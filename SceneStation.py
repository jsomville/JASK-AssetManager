...
class SceneStation(Scene):
    ...
    def __init__(self):
        ...
        #Library and Objects
        self.library = LibraryManager().stations
        self.index = 0
    ...
    def update_object(self):
        self.station = self.library[self.index]
        
        self.item["text"] = self.station.name

        x = self.size[0] // 2
        y = self.size[1] // 2
        self.station.update((x,y))
